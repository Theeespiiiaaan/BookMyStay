        ...
        <div class="container">
            <form method="POST" action="/checkin-submit">
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control col-sm-10" id="guestFullName" name="guestFullName" value="${reservation.guestFullName}">    
                    </div>
                </div>
                <div class="form-group row mb-2">
                ...
                <div class="form-group row mb-2">
                    <label for="id" class="col-form-label col-sm-2">Room</label>
                    <div class="col-sm-5">
                        <form:select class="form-select col-sm-10" id="roomId" name="roomId" path="reservation.room.id" value="${reservation.room.id}">
                            <form:options items="${rooms}" itemValue="id" itemLabel="type" />
                        </form:select>
                    </div>
                </div>
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-5">
                        <input type="number" class="form-control col-sm-10" id="deposit" name="deposit" value="${reservation.deposit}">    
                    </div>
                </div>
                <div class="form-group row mb-2">
